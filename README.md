<div align="center">
	...
	<p>
		...
		<br>
		C++, Microsoft Visual Studio, UML, StarUML, C#, ReSharper, Windows Forms, WPF, XAML, Microsoft .NET, MS SQL Server, SQL, T-SQL, VS Code, HTML5, CSS3, JavaScript, jQuery, XAMPP(Apache, PHP interpreter, MySQL), AJAX, SPA, PHP, PhpStorm, ASP.NET Core, Java.  
